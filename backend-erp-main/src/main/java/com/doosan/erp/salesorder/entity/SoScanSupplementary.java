...
@Getter
@Setter
public class SoScanSupplementary extends BaseEntity {
    ...
    @OneToMany(mappedBy = "scan", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<SoSupplementaryYarnSource> yarnSources = new ArrayList<>();

    @OneToMany(mappedBy = "scan", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<SoSupplementaryProductArticle> productArticles = new ArrayList<>();
