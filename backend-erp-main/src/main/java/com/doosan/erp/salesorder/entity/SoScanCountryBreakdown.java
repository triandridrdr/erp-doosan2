...
@Entity
@Table(name = "so_scan_country_breakdown")
@Getter
@Setter
public class SoScanCountryBreakdown extends BaseEntity {
    ...
    private List<SoCountryBreakdown> countryBreakdowns = new ArrayList<>();

    @OneToMany(mappedBy = "scan", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<SoColourSizeBreakdown> colourSizeBreakdowns = new ArrayList<>();
}
